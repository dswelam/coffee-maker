...
const ListIngredientsComponent = () => {
  ...
  const handleAddIngredient = () => {
    ...
    updateInventory(payload)
      .then(() => {
        // add to local inventory so table shows updated
        ...
        setError('');
        fetchInventory(); // refresh from backend to be safe
      })
      .catch(err => {
        console.error(err);
              ...
              <tr>
                ...
                <td>
                  <div className="d-flex justify-content-center">
                    ...
                    />
                    <button className="btn btn-success fw-bold" onClick={handleAddIngredient}>
                      +
                    </button>
                  </div>
                </td>
